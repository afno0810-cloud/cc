...
/* ================================================================
 ...
 Order: Hero (big Argus photo) → Who we are → Sponsors →
        Projects (Argus in live 3D) → Competitions → Get involved
...
addPropertyControls(HomePage, {
    ...
    argus3D: { type: ControlType.Boolean, title: "Argus 3D", defaultValue: true, description: "Argus as a big card with the live 3D harbour. The photo shows until the 3D has loaded." },
